...
const mongoDBConnectionString = "mongodb+srv://nk:admin@cluster0.nc6ci.mongodb.net/JeansShop?retryWrites=true&w=majority";
...
data.connect({useNewUrlParser: true}).then(()=>{
